...
function run_algo(N, S, J_PSP, J_PUP)
    ...
    best_obj, best_prices, iter = polytime_heuristic(exo_utility, endo_coef, start_prices, a, b)
	end).time
	...
	time_heur = (@timed begin
	best_obj, best_prices, iter = polytime_heuristic(exo_utility, endo_coef, start_prices, a, b)
	best_obj, best_prices, iterations = extended_line_search(exo_utility, endo_coef, a, b, best_prices, best_obj)
	end).time
	println("time_heur     = ",time_heur)
